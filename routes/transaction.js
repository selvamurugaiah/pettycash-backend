...
const { addUser, userLogIn } = require('../controllers/userLogin');
    ...
    try {
        ...
        if(setusertoken){
            const mailOptions = {
                ...
                text:`This Link Valid For 2 MINUTES https://super-youtiao-470e8c.netlify.app/forgotpassword/${userfind.id}/${setusertoken.verifytoken}`
            }
